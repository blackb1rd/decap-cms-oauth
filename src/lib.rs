...
use oauth2::{
    AsyncHttpClient, AuthUrl, ClientId, ClientSecret, EndpointNotSet, EndpointSet, HttpRequest,
    RedirectUrl, TokenUrl, basic::BasicClient,
};
use std::env;
...
impl<'c> AsyncHttpClient<'c> for AppState {
...
fn create_client(redirect_url: String) -> ConfiguredClient {
